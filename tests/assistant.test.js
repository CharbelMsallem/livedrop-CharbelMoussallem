...
const { classifyIntent } = require('../apps/api/src/assistant/intent-classifier'); // Adjust path
const { functionRegistry } = require('../apps/api/src/assistant/function-registry'); // Adjust path
const { runAssistant } = require('../apps/api/src/assistant/engine'); // Adjust path
