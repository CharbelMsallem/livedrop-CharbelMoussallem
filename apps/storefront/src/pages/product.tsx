  ...
  if (!product) {
    return (
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        <p className="text-gray-600 text-sm">We couldn't find the product you're looking for.</p>
      </div>
    );
  }

  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-8 sm:mb-10">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-3 mb-5 p-2.5 bg-teal-50/50 rounded-lg border border-teal-100">
